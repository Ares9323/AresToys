...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    private void ProbeSatellite()
    {
        try
        {
            ...
            if (rs is null)
            {
                _logger.LogWarning("Localization: no satellite resources found for '{Culture}'. Translations will fall back to English. Verify <output>/{Culture}/ShareQ.resources.dll exists; add the tag to <SatelliteResourceLanguages> in ShareQ.App.csproj if missing.",
